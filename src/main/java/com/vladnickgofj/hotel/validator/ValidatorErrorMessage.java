...
public class ValidatorErrorMessage {
    ...
    public static final String CONFIRMATION_PASSWORD_ERROR_MESSAGE = "Fields Password and ConfirmationPassword do not match";
    ...
    public static final String USER_ALREADY_EXIST_ERROR_MESSAGE = "User with this Email is already registered";
